...
$signed= hash_hmac('sha256', $signing, 'S-uR7ZS1tC-52NuBoE7FDYNQ');
if ($signed === $data['x_signature']) {
    if ($paidstatus == "Success"){ //payment success
        $sqlinsertpayment = "INSERT INTO `tbl_payments`( `user_email`,`payment_bill`, `payment_paid`) VALUES ('$email','$receiptid','$amount')";
